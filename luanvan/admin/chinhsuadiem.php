...
<?php 
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $sql = "SELECT sinhvien.mssv,sinhvien.hoten,lop.tenlop,ketqua.diemso FROM lop,`ketqua`,sinhvien where ketqua.id=$id and sinhvien.id = ketqua.idsv and lop.id = sinhvien.id_lop";//Lay thong tin cua de tai co id lay từ thanh địa chỉ
    ...
    if(isset($_POST['luu'])){
        ...
        if(isset($_POST['diemso']) ){
            $diemso = $_POST['diemso'];//lay du lieu tu nguoi dung
        ...
        if($diemso == '' ){
            $_SESSION['message_edit'] = 'Vui lòng nhập điểm';
        }else{
            if($diemso>10 || $diemso<0){
                $_SESSION['message_edit'] = 'Nhập điểm hợp lệ từ 0->10';
            }else{
                $sql = "UPDATE ketqua set diemso='$diemso', diemchu='$diemchu' where id = $id";
                $res = mysqli_query($conn,$sql);
                if($res == true){
...
<body>
    <div class="container">
        ...
        <section class="thongtinsinhvien  mt-3">
            <a href="/luanvan/admin/ketqua.php"><img src="/luanvan/images/arrow-left.png" alt=""></a>
            <h4 class="mt-3 mb-3">CHỈNH SỬA ĐIỂM SINH VIÊN</h4>
                ...
                <div id="thongtincanhan" class="mb-3 text-center ">
                    ...
                    <form action="" method="POST">
                        <div class="text">
                            ...
                            <div>
                                <input name="mssv" value="<?php if(isset($mssv)) echo $mssv; ?>" disabled type="text" class="form-control" >
                            </div>
                        </div>
                        <div class="text">
                            <div>
                            ...
                            <div>
                                <input  name="hoten" value="<?php if(isset($hoten)) echo $hoten; ?>" disabled type="text" class="form-control" >
                            </div>
                        </div>
                        <div class="text">
                            <div>
                            ...
                            <div>
                                <input  name="hoten" value="<?php if(isset($lop)) echo $lop; ?>" disabled type="text" class="form-control" >
                            </div>
                        </div>
                        <div class="text">
                            <div>
                            ...
                            <div>
                                <input  name="diemso" value="<?php if(isset($diemso)) echo $diemso; ?>" type="text" class="form-control" >
                            </div>
                        </div>
